...
/**
 * Controlador para la interfaz del dashboard en la aplicación. Maneja la lógica
 * de la interfaz de usuario relacionada con el panel principal y la selección
 * de temas.
 *
 * @author Oier
 */
public class FXMLDashboardController {
    ...
    /**
     * Establece la escena para el controlador y carga los estilos
     * predeterminados.
     *
    ...
    /**
     * Inicializa el controlador y configura los eventos para el menú de temas y
    ...
    /**
     * Crea un menú contextual que permite seleccionar diferentes temas de la
     * interfaz.
     *
