...
/**
 * Servidor de aplicaciones que acepta conexiones de clientes y gestiona
 * la comunicación con ellos mediante sockets. Permite también cerrar el servidor
 * desde la consola.
 * 
 * @author gorka
 */
public class AplicattionServer {
    ...
    /**
     * Método principal que arranca el servidor, carga la configuración del puerto,
     * y maneja las excepciones que puedan surgir.
     * 
     * @param args Argumentos de la línea de comandos (no utilizados)
     * @throws ErrorMaxClientes Si se supera el número máximo de clientes permitidos
     */
    ...
    /**
     * Método que inicia el servidor y se encarga de aceptar conexiones de clientes.
     * Además, arranca un hilo para escuchar comandos de consola (como "cerrar").
     * 
    ...
    /**
     * Método que se ejecuta en un hilo separado para escuchar comandos desde la consola.
     * Permite al usuario escribir "cerrar" para detener el servidor.
     */
    ...
    /**
     * Método que finaliza la ejecución del servidor, cerrando los sockets abiertos.
     */
    ...
    /**
     * Obtiene el número máximo de clientes permitidos desde un archivo de propiedades.
     * 
    ...
    /**
     * Método sincronizado que decrementa el número de clientes conectados.
     * Este método se debe llamar cuando un cliente se desconecta.
     */
    ...
    /**
     * Carga el número de puerto desde un archivo de propiedades y valida que sea un número válido.
     * 
     * @throws NumberFormatException Si el valor del puerto no es un número válido
     */
