 ...
 * El objetivo de esta clase es gestionar un conjunto de conexiones a la base de datos 
 * para evitar la sobrecarga de abrir y cerrar conexiones repetidamente. 
 * Permite obtener y devolver conexiones de manera eficiente.
 * 
 * El Pool de Conexiones gestiona un conjunto de conexiones libres y ocupadas. Cuando
 * se solicita una conexión, si hay alguna libre, se toma del conjunto de conexiones libres,
 * si no, se crea una nueva conexión (hasta alcanzar el tamaño máximo de conexiones).
 * 
 * @author oier
 */
public class PoolConexiones {
    ...
    /**
     * Constructor de la clase PoolConexiones, que configura el pool con los parámetros
     * definidos en un archivo de propiedades.
     * 
     ...
     * @throws SQLException Si no se puede cargar la configuración o establecer la conexión.
     */
    ...
    /**
     * Constructor que utiliza configuraciones predeterminadas de un archivo de propiedades.
     * 
     * @throws SQLException Si no se puede cargar la configuración o establecer la conexión.
     */
    ...
    /**
     * Obtiene una conexión del pool. Si el pool está lleno, crea una nueva conexión.
     * 
     ...
     * @throws SQLException Si no se puede obtener una conexión del pool o crear una nueva.
     */
     ...
     * 
     * El pool se considera lleno si no hay conexiones libres y ya se ha alcanzado
     ...
     * 
     * Realiza una consulta SQL simple para verificar la disponibilidad de la conexión.
     * 
     * @param conn La conexión a verificar.
