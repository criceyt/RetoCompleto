...
/**
 * Clase de acceso a datos que implementa la interfaz Signable para gestionar
 * la autenticación y el registro de usuarios. Conecta con la base de datos para
...
public class DAO implements Signable {
    ...
    /**
     * Método que gestiona el inicio de sesión de un usuario. Verifica las credenciales
     * y si el usuario está activo. Si el inicio de sesión es exitoso, retorna el usuario
     * autenticado.
     * 
     * @param mensaje Objeto que contiene el usuario con las credenciales de inicio de sesión.
     ...
     * @throws ErrorUsuarioInexistente Si el usuario no existe en la base de datos.
     */
    @Override
    ...
    /**
     * Método que gestiona el registro de un nuevo usuario. Verifica si el correo electrónico
     * ya está registrado y, en caso contrario, inserta los datos del nuevo usuario en la base de datos.
     * 
     * @param mensaje Objeto que contiene los datos del nuevo usuario.
     * @return Usuario registrado.
     * @throws ErrorCorreoExistente Si el correo electrónico ya está registrado en la base de datos.
     * @throws ErrorGeneral Si ocurre un error general durante la operación.
     */
    @Override
