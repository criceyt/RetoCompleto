...
/**
 * Clase que representa un "worker" (hilo de trabajo) en el servidor. Cada vez
 * que un cliente se conecta, se crea una instancia de esta clase para manejar
 * la comunicación con ese cliente de manera independiente.
 *
 * Un worker es responsable de procesar las peticiones de autenticación o
 * registro enviadas por los clientes.
 *
 * El worker recibe los mensajes del cliente, procesa la solicitud de inicio de
 * sesión o registro, y responde al cliente con un mensaje que indica el
...
public class Worker implements Runnable {
    ...
    /**
     * Constructor para crear una instancia de Worker, asignando el socket de
     * cliente, el objeto de salida y el DAO para interactuar con la base de
     * datos.
     *
    ...
    /**
     * Método ejecutado cuando el hilo es iniciado. Este método es responsable
     * de procesar las solicitudes de los clientes. El worker recibirá un
     * mensaje del cliente, procesará la solicitud (registro o inicio de sesión)
    ...
    /**
     * Método para cerrar los recursos utilizados por este worker, como el
     * socket y los flujos de entrada y salida. Se asegura de liberar los
     * recursos una vez que el worker ha terminado de procesar al cliente.
     */
