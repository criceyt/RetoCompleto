 ...
 *
 * Se utiliza para representar errores no específicos que ocurren en el
 * servidor, los cuales no son cubiertos por otras excepciones más específicas.
 *
 * @author oier
 */
public class ErrorGeneral extends Exception {
     ...
     * predeterminado que indica que ha ocurrido un error general en el
     * servidor.
     */
    public ErrorGeneral() {
