 ...
 * sistema, específicamente para el registro y la autenticación.
 *
 ...
 *
 * En ambos métodos, si ocurre algún error durante el proceso (por ejemplo, si
 * el correo ya está registrado, el usuario no existe, etc.), se lanzan
...
public interface Signable {
     ...
     * @throws ErrorGeneral Si ocurre un error general durante el proceso de
     * registro.
     * @throws ErrorCorreoExistente Si el correo del usuario ya está registrado
     * en el sistema.
     ...
     *
     * @param mensaje Objeto que contiene las credenciales del usuario para el
     * inicio de sesión.
     * @return El objeto `Usuario` que ha iniciado sesión correctamente.
     * @throws ErrorGeneral Si ocurre un error general durante el proceso de
     * inicio de sesión.
     * @throws ErrorUsuarioNoActivo Si el usuario no está activo y no puede
     * iniciar sesión.
