...
public class Usuario implements Serializable {
     ...
     * 
     * Este constructor inicializa todos los atributos de la clase con los valores proporcionados.
     * 
    ...
    /**
     * Constructor con los parámetros mínimos (email y password) para crear un objeto `Usuario`.
     * 
     * Este constructor es útil cuando solo se necesitan las credenciales del usuario para el
    ...
    /**
     * Constructor por defecto. Crea un objeto `Usuario` sin inicializar los atributos.
     */
    public Usuario() {
    }
     ...
     * 
     * @param nombreyApellidos El nombre y apellidos que se asignarán al usuario.
     */
     ...
     * 
     * @param estaActivo El estado de actividad que se asignará al usuario (`true` si está activo, `false` si no).
     */
