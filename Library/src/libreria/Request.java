...
/**
 * Enumeración que define los posibles tipos de solicitudes y respuestas 
 * que se pueden manejar entre el servidor y el cliente. 
 * 
 * Esta clase enum contiene las diferentes acciones que un cliente puede 
 * solicitar al servidor, como iniciar sesión, registrarse, o respuestas 
 * de error relacionadas con el estado del usuario o el sistema. 
 * 
 * @author gorka
 */
public enum Request {
