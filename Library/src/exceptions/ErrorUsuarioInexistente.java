...
/**
 * Excepción personalizada para manejar el caso en el que un usuario no se encuentra 
 * en la base de datos, lo que indica que el usuario no existe.
 * 
 * Se utiliza para notificar cuando se intenta acceder a un usuario que no está registrado 
